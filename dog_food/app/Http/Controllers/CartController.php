...
class CartController extends Controller
{
    ...
    public function add_to_cart(Request $request) {
        if ($request->session()->has('cart')) {
            $cart = $request->session()->get('cart'); // ['prod.id' => [prod.data]]

            $products_array_ids = array_column($cart, 'id'); // id's of added products

            $id = $request->input('id'); // current request product id
    ...
    public function remove_from_cart(Request $request) {
        ...
        if ($request->session()->has('cart')) {
            ...
            $total = $this->calculateTotalCart($request);
