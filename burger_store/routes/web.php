...
Route::middleware([
    ...
    Route::get('/dashboard', [ProjectController::class, 'user_orders'])->name('dashboard');
});
...
Route::middleware(['auth:sanctum', 'verified'])->get('/dashborad', [ProjectController::class, 'user_orders'])->name('dashboard');

// Route::middleware(['auth:sanctum', 'verified'])->get('/dashborad', function() {
//     return view('dashboard');
// })->name('dashboard');
