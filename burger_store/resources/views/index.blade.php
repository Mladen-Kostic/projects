            ...
            <div class="col-sm-4">
                <div class="menu">
                    <div class="inner_content">
                        <span class="flaticon flaticon-burger"></span>
                        <h2><a class="index-link-widgets" href="{{ route('category', ['category' => 'burger']) }}">burger</a></h2>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="drinks">
                    <div class="inner_content">
                        ...
                        <h2><a class="index-link-widgets" href="{{ route('category', ['category' => 'beverages']) }}">drinks</a></h2>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="sides">
                    <div class="inner_content">
                        ...
                        <h2><a class="index-link-widgets" href="{{ route('category', ['category' => 'sides']) }}">sides</a></h2>
                    </div>
                </div>
            </div>
